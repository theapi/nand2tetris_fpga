                ...
                3'd2: 
                    begin
                        ...
                        if (instruction[15] == 0) begin  
                            ...
                            // This must be done now as only now do we have the results of the alu.
                            ...
                            if (instruction[5] == 1) begin
                                ...
                                r_addressM <= ARegister[14:0]; // The current contents of A from the previous step.
                            end
