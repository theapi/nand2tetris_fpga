...
add wave -noupdate -radix hexadecimal -childformat {{{/ascii_tb/ascii_DUT/char_code[2]} -radix hexadecimal} {{/ascii_tb/ascii_DUT/char_code[1]} -radix hexadecimal} {{/ascii_tb/ascii_DUT/char_code[0]} -radix hexadecimal}} -expand -subitemconfig {{/ascii_tb/ascii_DUT/char_code[2]} {-radix hexadecimal} {/ascii_tb/ascii_DUT/char_code[1]} {-height 15 -radix hexadecimal} {/ascii_tb/ascii_DUT/char_code[0]} {-height 15 -radix hexadecimal}} /ascii_tb/ascii_DUT/char_code
add wave -noupdate /ascii_tb/ascii_DUT/char_counter
